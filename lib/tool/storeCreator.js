...
module.exports = (state = {}) => {
  ...
  // use funsee-smart ?
  const packageJson = require(`${global.__ROOT_PATH__}/package.json`);
  if (packageJson && packageJson.dependencies['funsee-smart']) {
    funseeReducer.smart = require('funsee-smart').reducer;
  }
